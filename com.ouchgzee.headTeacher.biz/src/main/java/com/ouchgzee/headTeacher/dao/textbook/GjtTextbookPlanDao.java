...
import com.ouchgzee.headTeacher.dao.textbook.repository.GjtTextbookPlanRepository;
import com.ouchgzee.headTeacher.pojo.textbook.BzrGjtTextbookPlan;

@Deprecated @Repository("bzrGjtTextbookPlanDao") // 为将来班主任的entity/dao/service模块合并到管理后台做准备，合并后尽可能的少在班主任上写代码，防止Spring容器name冲突，组件的name需加前缀bzr
public class GjtTextbookPlanDao {

	@Autowired
	private GjtTextbookPlanRepository gjtTextbookPlanRepository;
	
	public Page<BzrGjtTextbookPlan> findAll(Specification<BzrGjtTextbookPlan> spec, PageRequest pageRequst) {
