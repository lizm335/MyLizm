 ...
 */
@Controller
@RequestMapping("/usermanage/inspector")
public class InspectorController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		return "usermanage/inspector/list";
	}
	...
	public String viewForm(@PathVariable("id") String id, Model model, HttpServletRequest request) {
		...
		return "usermanage/inspector/form";
	}
	...
	public String create(@Valid GjtEmployeeInfo item, RedirectAttributes redirectAttributes, String loginAccount) {
		...
		try {
			...
			gjtEmployeeInfoService.saveEntity(item, gjtUserAccount, String.valueOf(EmployeeTypeEnum.督导教师.getNum()));
		} catch (Exception e) {
			feedback = new Feedback(false, "创建失败");
		}
		redirectAttributes.addFlashAttribute("feedback", feedback);
		return "redirect:/usermanage/inspector/list";
	}
