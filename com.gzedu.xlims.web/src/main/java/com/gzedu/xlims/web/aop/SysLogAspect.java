...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.gzedu.xlims.common.annotation.SysLog) || execution(* com.gzedu.xlims..controller..create(..)) || execution(* com.gzedu.xlims..controller..update(..)) || execution(* com.gzedu.xlims..controller..delete*(..))")
	public void logPointCut() {
	}

	@Pointcut("execution(* com.gzedu.xlims.webservice.controller..*.*Controller..*(..)) "
			+ "&& @annotation(org.springframework.web.bind.annotation.RequestMapping)")
	public void webservicePointCut() {
	}

	// 环绕通知 方法访问前后处理
	@Around("logPointCut() || webservicePointCut()")
	public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		try {
			...
			slt.getSysLog().setPlatfromType(1); // 管理平台
			// // 放入线程池中执行
