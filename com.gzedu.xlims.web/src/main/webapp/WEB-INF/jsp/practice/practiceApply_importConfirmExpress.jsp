...
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">批量导入确认收到定稿</h3>
	</div>
				...
				<div class="box-body process-cnt-box">
					<div class="media left10 pad-t15 margin_r15">
						...
						<div class="media-body">
							为了方便你的工作，我们已经准备好了“定稿已寄送”状态的<br>
							《社会实践记录明细表》，你可以点击下面的下载按钮，下载标准模板。
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a class="btn btn-primary btn-lg" style='width:220px;' href="${ctx}/practiceApply/export?search_EQ_status=8">下载标准模板</a>
					</div>
					...
					<div class="table-block full-width" style="height:100%;">
						<div class="table-row">
							<div class="table-cell-block vertical-mid text-center">
								...
								请选择你要导入的《确认收到定稿名单》，并选择需要导入到的实践计划
								</p>
								<form id="uploadForm" action="${ctx}/practiceApply/importConfirmExpress" enctype="multipart/form-data" method="post">
									<div class="pad-t30 col-xs-8 col-xs-offset-2">
										<select name="practicePlanId" class="selectpicker show-tick form-control" data-size="5" data-live-search="true" >
    	...
    	$("#uploadForm").ajaxSubmit({
			...
			success: function(data) {
				if (data.successful) {
					...
					$("#successFileName").attr("href", ctx+"/excelImport/downloadResult?path=practiceApply&name="+data.successFileName);
					$("#failedFileName").attr("href", ctx+"/excelImport/downloadResult?path=practiceApply&name="+data.failedFileName);
