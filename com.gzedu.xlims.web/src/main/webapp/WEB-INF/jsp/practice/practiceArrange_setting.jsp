...
<!-- <script type="text/javascript">
	var practicePlanId = '${practicePlan.practicePlanId}';
	if (!practicePlanId) {
		alert("当前没有可设置的社会实践安排！");
		history.back();
	}
</script> -->
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#">实践管理</a></li>
		<li><a href="#">实践安排</a></li>
		<li class="active">设置社会实践安排</li>
	</ol>
</section>
<section class="content">
	<div class="box margin-bottom-none">
		<form id="theform" class="theform" role="form" action="${ctx}/practiceArrange/create" method="post">
					...
					<div class="row">
						<div class="col-sm-4 col-xs-6">
				          <div class="form-group">
				            ...
				            <div class="col-sm-9">
				              <select id="practicePlanId" name="practicePlanId" class="selectpicker show-tick form-control" data-size="8">
								 <c:forEach items="${list }" var="practicePlan">
								  <option value="${practicePlan.practicePlanId}" <c:if test="${practicePlanId eq practicePlan.practicePlanId }">selected</c:if>>${practicePlan.practicePlanName}</option>
							  	</c:forEach>
							  </select>
				            </div>
				          </div>
...
$('#practicePlanId').change(function(){
	location.href="${ctx}/practiceArrange/create?practicePlanId="+$(this).val();
});
...
;(function(){
	...
	var postForm=$theform.Validform({
	  ...
	  callback:function(data){
		  if (data.successful) {
			  window.location.href = "${ctx}/practiceArrange/list";
		  } else {
			  alert(data.message);
		  }
	  }
