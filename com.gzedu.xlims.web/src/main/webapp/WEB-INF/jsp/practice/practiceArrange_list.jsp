...
<section class="content">
	      ...
	      <div class="row pad-t15">
	        <div class="col-sm-4 col-xs-6">
	          <div class="form-group">
	            ...
	            <div class="col-sm-9">
	              <select name="search_EQ_gjtPracticePlan.practicePlanId" class="selectpicker show-tick form-control" 	data-size="5" data-live-search="true">
	...
	<div class="box margin-bottom-none">
		<div class="box-header with-border">
		  <h3 class="box-title pad-t5">实践安排列表</h3>
		  <div class="pull-right no-margin">
		  	<c:if test="${isBtnCreate }">
		    	<a href="create" class="btn btn-default btn-sm"><i class="fa fa-fw fa-plus"></i> 设置社会实践安排</a>
		    </c:if>
		  </div>
		</div>
		<div class="box-body">
								...
								<c:forEach items="${pageInfo.content}" var="entity">
									<c:if test="${not empty entity}">
						            	<tr>
						            		...
						            		<td><a href="listStudent?practicePlanId=${entity.gjtPracticePlan.practicePlanId}&specialtyBaseId=${entity.gjtSpecialtyBase.specialtyBaseId}">${entity.canApplyNum}</a></td>
						            		<td>
						            			${entity.applyNum}
						            		...
						            		<td>
						            			<c:choose>
						            				<c:when test="${not empty entity.gjtPracticeAdvisers}">
						            					${fn:length(entity.gjtPracticeAdvisers)}
						            				</c:when>
						            				<c:otherwise>
