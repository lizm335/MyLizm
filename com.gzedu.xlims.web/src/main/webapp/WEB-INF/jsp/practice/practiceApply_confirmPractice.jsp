...
<body>
<form id="theform" action="${ctx}/practiceApply/confirmPractice" method="post">
    <input type="hidden" name="applyId" value="${param.applyId}">
    <input type="hidden" id="autograph" name="autograph" value="" />
	<div class="box no-border no-shadow">
		<div class="box-header with-border">
	      <h3 class="box-title">社会实践初稿确认定稿</h3>
	    </div>
	    <div class="box-body scroll-box">
	    	<%-- <div>
				<textarea name="content" class="form-control" placeholder="请填写社会实践初稿定稿意见" rows="10" datatype="*" nullmsg='<i class="fa fa-exclamation-circle f16 vertical-middle"></i> 请填写定稿意见' errormsg="请填写定稿意见"></textarea>
				<span class="Validform_checktip no-margin"></span>
			</div>
			<div class="margin_t10">
				
				<input name="reviewScore" type="text" class="form-control inline-block vertical-middle margin_r10" placeholder="请填写社会实践初稿定稿得分" style="width:35%" datatype="n" nullmsg='<i class="fa fa-exclamation-circle f16 vertical-middle"></i> 请填写定稿得分' errormsg='<i class="fa fa-exclamation-circle f16 vertical-middle"></i> 请填写数字'>

				<small class="inline-block gray9 vertical-middle">说明：社会实践初稿确认定稿，得分不能少于60分</small>
