...
<section class="content">
	...
	<div class="box margin-bottom-none">
		<div class="box-header with-border">
		  <h3 class="box-title pad-t5">社会实践记录列表</h3>
								...
								<c:forEach items="${pageInfo.content}" var="entity">
									<c:if test="${not empty entity}">
						            	<tr>
						            		...
						            		<td>
						            			<div class="text-left">
						            				姓名：<span class="xm">${entity.gjtStudentInfo.xm}</span> <br>
...
$(function() {
	...
	$(".btn-export").click(function(event) {
		window.open(ctx + "/practiceApply/export?" + $("#listForm").serialize());
	});
	...
	$("html").confirmation({
		  ...
		  onConfirm:function(event,element){
			  ...
			  window.location.href = ctx + "/practiceApply/confirmExpress?applyId=" + id;
		  },
