...
<div class="box no-border">
	...
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li class="process-step1 actived cur"><i></i>1.${param.step1}</li>
			<li class="process-step2"><i></i>2.${param.step2}</li>
			<li class="process-step3">3.${param.step3}</li>
		</ol>
			...
			<div class="step-item">
				<div class="box-body process-cnt-box">
					...
					<div class="text-center pad-t30 margin_t10">
						<a class="btn btn-primary btn-lg" style='width:220px;' href="${param.downloadFileUrl}">${param.downloadButton}</a>
					</div>
							...
							<div class="table-cell-block vertical-mid text-center">
								...
								<div class="pad-t30 col-xs-8 col-xs-offset-2">
									<div class="input-group input-group-md">
					                    ...
					                    <form id="uploadForm" action="${param.actionName}" enctype="multipart/form-data" method="post">
					                    	<input type="file" id="fileInput" class="hide" name="${param.fileParamName}" />
					                    </form>
    	...
    	$("#uploadForm").ajaxSubmit({
			...
			success: function(data) {
				...
				if (data.successful) {
					...
					$("#successFileName").attr("href", ctx+"/excelImport/downloadResult?path="+path+"&name="+data.successFileName);
					$("#failedFileName").attr("href", ctx+"/excelImport/downloadResult?path="+path+"&name="+data.failedFileName);
