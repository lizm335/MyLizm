						...
						validators: {
							...
							callback: {
								...
								callback: function(value, validator) {
									...
									$.ajax({
										type : "post",
										url : "${ctx}/organization/branch/checkCode",
										dataType:'json',
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">新增分部</li>
		</c:if>
		<c:if test="${action=='update'}">
		<li class="active">编辑分部</li>
		</c:if>
	</ol>
</section>
<section class="content" data-id="0">
	<div class="box margin-bottom-none">
		<form id="inputForm" class="form-horizontal" role="form" action="${ctx }/organization/branch/${action}" method="post">
		...
		<div class="box-body">
			<div class="form-horizontal reset-form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>分部代码</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="code" value="${entity.code}"placeholder="请输入分部代码" id="code">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>分部名称</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="orgName" value="${entity.orgName}" placeholder="请输入分部名称">
					</div>
				</div>	
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input class="form-control" type="text" name="gjtSchoolInfo.xxdz" value="${entity.gjtSchoolInfo.xxdz}" placeholder="请输入分部详细地址">
					</div>
				</div>
