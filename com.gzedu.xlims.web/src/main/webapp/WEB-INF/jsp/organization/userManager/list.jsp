...
<body class="inner-page-body">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li>机构管理</li>
			<li><a href="${ctx }/organization/org/list">院校管理</a></li>
	...
	<section class="content" data-id="0">
		<form class="form-horizontal" id="listForm" action="list.html">
			<input type="hidden" name="orgId" value="${gjtOrg.id }">
			<div class="box">
				<div class="box-body">
						...
						<div class="col-md-4">
							...
							<div class="col-sm-9">
								<select name="search_EQ_gjtOrg.id" class="selectpicker show-tick form-control" 	data-size="5" data-live-search="true">
										<option value="${gjtOrg.id}" selected='selected'>${gjtOrg.orgName}</option>
								</select>
							</div>
						</div>
					</div>
			...
			<div class="box">
				<div class="box-header with-border">
					<div class="fr">
						...
						<div class="btn-wrap fl">
							<a href="create?orgId=${gjtOrg.id}" class="btn btn-default btn-sm">
											...
											<tr>
												...
												<td>
													<div class="data-operion">
														<a href="update/${item.id}?orgId=${param['search_EQ_gjtOrg.id']}"
