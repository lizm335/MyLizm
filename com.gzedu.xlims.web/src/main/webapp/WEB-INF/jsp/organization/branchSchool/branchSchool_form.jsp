						...
						validators: {
							...
							callback: {
								...
								callback: function(value, validator) {
									...
									$.ajax({
										type : "post",
										url : "${ctx}/organization/branchSchool/checkCode",
										dataType:'json',
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">新增分校</li>
		</c:if>
		<c:if test="${action=='update'}">
		<li class="active">编辑分校</li>
		</c:if>
	</ol>
</section>
<section class="content" data-id="0">
	<div class="box margin-bottom-none">
		<form id="inputForm" class="form-horizontal" role="form" action="${ctx }/organization/branchSchool/${action}" method="post">
        <input id="action" type="hidden" name="action" value="${action}">
        <input type="hidden" name="id" value="${entity.id}">
		<div class="box-body">
			<div class="form-horizontal reset-form-horizontal">
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>上级单位</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
					<c:if test="${action=='create'}">
						<input class="form-control" type="text" name="code" value="${entity.code}"placeholder="请输入分校代码" id="code">
					</c:if>
					<c:if test="${action=='update'}">
						<input class="form-control" type="text"  value="${entity.code}"placeholder="请输入分校代码" id="code" disabled="disabled">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>分校地址</label>
					<div class="col-sm-8">
						<div class="row">
							<div class="col-sm-4">
								<select id="province" class="select2 form-control"   >
									<option value="" ></option>
								</select>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-sm-4">
								<select id="district" name="gjtSchoolInfo.xxqhm" class="select2 form-control" >
									<option value="${entity.gjtSchoolInfo.xxqhm}" ></option>
								</select>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input class="form-control" type="text" name="gjtSchoolInfo.xxdz" value="${entity.gjtSchoolInfo.xxdz}" placeholder="请输入分校详细地址">
					</div>
				</div>
