...
<head>
	...
	$(function() {
		if($('#action').val() == 'view'){
			...
			$('#go_for_back').removeAttr("disabled");
						...
						validators: {
							...
							callback: {
								...
								callback: function(value, validator) {
									...
									$.ajax({
										type : "post",
										url : "${ctx}/organization/org/checkCode",
										dataType:'json',
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">新增院校</li>
		</c:if>
		<c:if test="${action=='view'}">
		<li class="active">院校详情</li>
		</c:if>
		<c:if test="${action=='update'}">
		<li class="active">编辑院校</li>
		</c:if>
	</ol>
</section>
<section class="content" data-id="0">
	<div class="box margin-bottom-none">
		<form id="inputForm" class="form-horizontal" role="form" action="${ctx }/organization/org/${action}" method="post">
        <input id="action" type="hidden" name="action" value="${action}">
        <input type="hidden" name="id" value="${entity.id}">
		<div class="box-body">
			<div class="form-horizontal reset-form-horizontal">
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>院校代码</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="code" value="${entity.code}"placeholder="请输入院校代码" id="code">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>院校名称</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="orgName" value="${entity.orgName}" placeholder="请输入院校名称">
					</div>
				</div>	
				<div class="form-group">
