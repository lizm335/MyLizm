	...
	<form class="form-horizontal" id="listForm" action="list.html">
		<div class="box">
			  ...
			  <div class="row pad-t15">
				<div class="col-sm-4 col-xs-6">
				  <div class="form-group">
					<label class="control-label col-sm-3 text-nowrap">招生点代码</label>
					<div class="col-sm-9">
				...
				<div class="col-sm-4 col-xs-6">
				  <div class="form-group">
					<label class="control-label col-sm-3 text-nowrap">招生点名称</label>
					<div class="col-sm-9">
		  ...
		  <div class="box-footer">
			<shiro:hasPermission name="/organization/enrollStudent/list$reset">
		...
		<div class="box">
			<div class="box-header with-border">
			  <h3 class="box-title pad-t5">招生点列表</h3>

			 <shiro:hasPermission name="/organization/enrollStudent/list$create">
			  <div class="pull-right no-margin">
				<a role="button" href="toCreate" class="btn btn-default btn-sm"><i class="fa fa-fw fa-plus"></i> 新增招生点</a>
			  </div>
			 </shiro:hasPermission>
			</div>
			<div class="box-body">
						...
						<tr>
						  ...
						  <td>
							<div class="data-operion">
								<shiro:hasPermission name="/organization/enrollStudent/list$edit">
									<a href="update/${entity.id}" class="operion-item operion-view" data-toggle="tooltip" title="编辑"><i class="fa fa-fw fa-edit"></i></a>
								</shiro:hasPermission>
							  	<shiro:hasPermission name="/organization/enrollStudent/list$delete">
									<a href="${ctx}/organization/enrollStudent/deleteOrg/${entity.id}" val="${entity.id}" class="operion-item operion-view" data-toggle="tooltip" title="删除" data-role="sure-btn-1"><i class="fa fa-fw fa-trash-o text-red"></i></a>
							  	</shiro:hasPermission>
							  	<shiro:hasPermission name="/organization/enrollStudent/list$startOrstop">
								  	<c:if test="${entity.isEnabled eq '1'}">
										<a href="javascript:;" onclick="changeStatus('${ctx}/organization/enrollStudent/changeStatus/${entity.id}/${entity.isEnabled}',$(this),'${entity.isEnabled}')" 
