						...
						validators: {
							...
							callback: {
								...
								callback: function(value, validator) {
									...
									$.ajax({
										type : "post",
										url : "${ctx}/organization/enrollStudent/checkCode",
										dataType:'json',
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#">新增招生点</a></li>
		</c:if>
		<c:if test="${action=='update'}">
		<li><a href="#">编辑招生点</a></li>
		</c:if>
	</ol>
</section>
<section class="content">
	<div class="box margin-bottom-none">
	<form id="inputForm" class="form-horizontal" role="form" action="${ctx }/organization/enrollStudent/${action}" method="post">
		...
		<div class="box-body">
			<div class="form-horizontal reset-form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>招生点代码</label>
					<div class="col-sm-8">
						<c:if test="${action=='create'}">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><small class="text-red">*</small>招生点名称</label>
					<div class="col-sm-8">
						<input class="form-control" type="text" name="orgName" value="${entity.orgName}" placeholder="请输入招生点名称">
					</div>
				</div>
			...
			<div class="col-sm-8">
				<input type="text" name="gjtStudyCenter.officeAddr" class="form-control" value="${entity.gjtStudyCenter.officeAddr}" placeholder="请输入招生点详细地址"/>
			</div>
		   </div>
