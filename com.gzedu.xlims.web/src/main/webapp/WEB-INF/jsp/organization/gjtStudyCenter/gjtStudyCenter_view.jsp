...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#">学习中心管理</a></li>
		<li class="active">学习中心详情</li>
	</ol>
</section>
	...
	<div class="box margin-bottom-none">
		<div class="box-body">
			<div class="form-horizontal reset-form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">学习中心名称：</label>
					<div class="col-sm-8 ">
					...
					<div class="tab-pane ">
						<div class="approval-list clearfix">
							...
							<c:forEach items="${list }" var="item" varStatus="var">
								...
								<c:if test="${item.auditStep eq '3'  or item.auditStep eq '0'}">
									<dl class="approval-item">
										<dt class="clearfix">
				...
				$.confirm({
					...
					confirm : function() {
						var dialog1 = $.mydialog({
						 ...
						 $.post("${ctx}/organization/gjtStudyCenter/audit",{orgCode:$orgCode,id:$id,audit:$status,content:$content},function(data){
