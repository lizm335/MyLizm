...
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">导入毕业审核记录</h3>
	</div>
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li class="process-step1 actived cur"><i></i>1.下载毕业审核记录导入模版</li>
			<li class="process-step2"><i></i>2.导入毕业审核记录</li>
		...
		<div class="step-box">
				...
				<div class="box-body process-cnt-box">
					<div class="media pad-t30 left10 margin_t10 margin_r15">
						...
						<div class="media-body">
							导入毕业审核记录前，建议先下载《毕业审核记录表》根据表设置好相关参数再导入。
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a href="javascript:void(0);" class="btn btn-primary btn-lg download_file" data-file="template">下载毕业审核记录表</a>
					</div>
			...
			<div class="step-item" style="display:none">
				<form id="uploadForm" name="uploadForm" action="importGraduationAudit" method="post" enctype="multipart/form-data">
						...
						<div class="table-row">
							<div class="table-cell-block vertical-mid text-center">
								<p class="text-bold f16">
									请选择你要导入的《毕业审核记录》，为保障导入修改能够顺利完成，导入前请确保表格模板正确，内容已按要求填写。
								</p>
...
$(function(){
	...
	$(".download_file").click(function(event) {
		window.location.href="downloadTemplate?file="+$(this).attr("data-file");
	});
