...
$(".import-sure-btn").click(function(event) {
	...
	var url='${ctx}/graduation/degreemanager/download?'+parent.$('#listForm').serialize();
	$pstate.val(restate);
	location.href=url;
	var $that=$(this);
	$overlay.show();
