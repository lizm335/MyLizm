				...
				<div class="box-body process-cnt-box">
					<div class="media pad-t30 left10 margin_t10 margin_r15">
						...
						<div class="media-body">
							为了方便你的工作，我们已经准备好了《教材导入表》的标准模板<br>
							你可以点击下面的下载按钮，下载标准模板。
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a class="btn btn-primary btn-lg" style='width:220px;' href="${ctx}/excel/download?name=教材导入表.xls">下载标准模板</a>
					</div>
							...
							<div class="table-cell-block vertical-mid text-center">
								...
								<div class="pad-t30 col-xs-8 col-xs-offset-2">
									<div class="input-group input-group-md">
					                    ...
					                    <form id="uploadForm" action="${ctx}/textbook/import" enctype="multipart/form-data" method="post">
							...
							<div class="table-cell-block vertical-mid">
								<div class="" style="width:305px;margin:0 auto;">
									...
									<p class="margin_b20">
										...
										&nbsp;
		              					<a id="successUrl" href="javascript:void(0)" class="btn btn-default btn-sm left10"><span>下载导入成功记录</span></a>
									</p>
									<p class="">
										...
										&nbsp;
										<a id="failedUrl" href="javascript:void(0)" class="btn btn-primary btn-sm left10"><span>下载导入失败记录</span></a>
									</p>
								</div>
							</div>
						</div>
    	...
    	$("#uploadForm").ajaxSubmit({
			...
			success: function(data) {
				if (data.successful) {
					...
					$("#successUrl").attr("href", ctx+"/tmp/download/textbook/"+data.successUrl);
					$("#failedUrl").attr("href", ctx+"/tmp/download/textbook/"+data.failedUrl);
