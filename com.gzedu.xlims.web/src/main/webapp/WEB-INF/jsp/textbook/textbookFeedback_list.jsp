	        ...
	        <div class="row pad-t15">
	          ...
	          <div class="col-sm-4">
	            <div class="form-group">
	              ...
	              <div class="col-sm-9">
	                <select name="search_EQ_feedbackType" class="selectpicker form-control">
		...
		<div class="box-body">
			<div class="filter-tabs filter-tabs2 clearfix">
				<ul class="list-unstyled">
					<li lang=":input[name='search_EQ_status']" <c:if test="${empty param['search_EQ_status']}">class="actived"</c:if>>全部(${pending + processed})</li>
					<li value="1" role=":input[name='search_EQ_status']" <c:if test="${param['search_EQ_status'] == 1}">class="actived"</c:if>>待处理(${pending})</li>
					<li value="2" role=":input[name='search_EQ_status']" <c:if test="${param['search_EQ_status'] == 2}">class="actived"</c:if>>已处理(${processed})</li>
				</ul>
			</div>
