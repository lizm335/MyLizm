                    ...
                    <c:choose>
                    	<c:when test="${orgType eq 'son' }">
                   			<div class="form-group">
		                        ...
		                        <div class="col-sm-6">
		                            <input type="text" class="form-control"    value="${schoolInfoMap.name}" disabled="disabled" >
		                            <input type="hidden" class="form-control"  name="xxId"  value="${schoolInfoMap.id}"  >
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="col-sm-3 control-label">
		                        ...
		                        <div class="col-sm-6">
		                             <input type="text" class="form-control"    value="${studyCenter.orgName}" disabled="disabled" >
		                            <input type="hidden" class="form-control" name="xxzxId"   value="${studyCenter.id}"  >
		                        </div>
		                    </div>
                    	</c:when>
                    	<c:otherwise>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-sm-6">
		                            <select class="selectpicker show-tick form-control" data-size="8" data-live-search="true"  name="xxzxId" id="xxzxId">
		                               <option value="">请选择</option>
		                                <c:forEach items="${studyCenterMap}" var="map">
		                                    <option value="${map.key}" <c:if test="${map.key==gjtEmployeeInfo.gjtStudyCenter.id}">selected='selected'</c:if> >${map.value}</option>
		                                </c:forEach>
		                            </select>
		                        </div>
		                    </div>
...
*/
    ...
    $(function(){
        ...
        $('#xxId').change(function(){
            var id = $('#xxId').val();
            $.post("${ctx}/edumanage/teachEmployee/querySchoolCenterBySchool.html?xxId="+id,
                function(data,status){
                    $('#xxzxId').empty();
                    $("#xxzxId").append("<option value=''>请选择</option>");
                    $.each(data, function (i) {
                        $("#xxzxId").append("<option value='"+data[i].key+"'>"+data[i].value+"</option>");
                    });
                    $('#xxzxId').selectpicker('refresh');
                }
                ,"json");
        });
