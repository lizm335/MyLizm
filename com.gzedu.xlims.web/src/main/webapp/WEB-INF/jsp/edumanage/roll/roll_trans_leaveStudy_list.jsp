            ...
            <c:forEach items="${pageInfo.content }" var="transaction">
              <tr>
                ...
                <td class="text-orange">
                 	...
                 	<c:choose>
                 	<c:when test="${transaction.auditOperatorRole==3}"><small class="gray9">（学习中心）</small></c:when>
                ...
                <td>
                  <a href="${ctx}/edumanage/rollTrans/tranLeaveStudy/view/${transaction.transactionId}/${transaction.gjtStudentInfo.studentId}" class="operion-item operion-view" data-toggle="tooltip" title="查看详情"><i class="fa fa-fw fa-view-more"></i></a>
                </td>
              </tr>
              </c:forEach>
            </tbody>
