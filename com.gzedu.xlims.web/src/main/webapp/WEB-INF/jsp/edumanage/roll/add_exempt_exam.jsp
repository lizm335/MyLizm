...
<section class="content-header clearfix">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#">学籍管理</a></li>
		<li><a href="#">免修免考</a></li>
		<li class="active">新增免修免考</li>
	</ol>
</section>
<section class="content">
	<form  class="theform" role="form" action="${ctx}/edumanage/exemptExamInstall/create" method="post">
		<div class="box no-margin">
			<div class="box-body pad20">
						...
						<tr>
							...
							<td width="35%">
								<div class="position-relative">
	                                <select name="search_EQ_courseId" class="form-control select2 full-width" data-placeholder="请选择统考课程" datatype="*" nullmsg="请选择统考课程" errormsg="请选择统考课程">
	                                    <option vaule=""></option>
							...
							<td width="35%">
								<div class="position-relative">
	                                <select name="gradeId" class="form-control select2 full-width" multiple="multiple">
	                                    <c:forEach items="${gradeMap}" var="map">
                                        	<option value="${map.key}_${map.value}"  <c:if test="${map.key==param.search_EQ_gradeId}">selected='selected'</c:if>>${map.value}</option>
                                    	</c:forEach>
	                                </select>
	                            </div>
							</td>
				...
				<table class="table table-bordered table-striped vertical-mid text-center f12 margin-bottom-none" data-role="set-model">
					...
					<tbody data-role="box">
						<tr>
							...
							<td>
								<div class="position-relative">
									<input name="materialName" type="text" class="form-control text-center input-xs" value="国家级考级证书" datatype="*" nullmsg="请填写材料证明" errormsg="请填写材料证明" placeholder="请填写材料证明">
					            </div>
							</td>
							<td>
								<div class="position-relative">
									<textarea name="memo" class="form-control f12 pad5" rows="3" placeholder="请填写备注" datatype="*" nullmsg="请填写备注" errormsg="请填写备注">非计算机类专业,获得全国计算机等级考试一级B或以上级别证书</textarea>
					            </div>
							</td>
							<td>
								<div class="position-relative">
						...
						<tr>
							...
							<td>
								<div class="position-relative">
									<input name="materialName" type="text" class="form-control text-center input-xs" value="单科合格证书（或成绩单）" datatype="*" nullmsg="请填写材料证明" errormsg="请填写材料证明" placeholder="请填写材料证明">
					            </div>
							</td>
							<td>
								<div class="position-relative">
									<textarea name="memo" class="form-control f12 pad5" rows="3" placeholder="请填写备注" datatype="*" nullmsg="请填写备注" errormsg="请填写备注">已参加统考，且成绩通过</textarea>
					            </div>
							</td>
							<td>
								<div class="position-relative">
						...
						<tr>
							...
							<td>
								<div class="position-relative">
									<input name="materialName" type="text" class="form-control text-center input-xs" value="毕业证书" datatype="*" nullmsg="请填写材料证明" errormsg="请填写材料证明" placeholder="请填写材料证明">
					            </div>
							</td>
							<td>
								<div class="position-relative">
									<textarea name="memo" placeholder="请填写备注" class="form-control f12 pad5" rows="3" datatype="*" nullmsg="请填写备注" errormsg="请填写备注">已具有国民教育系列本科以上学历</textarea>
					            </div>
							</td>
							<td>
								<div class="position-relative">
				...
				<a href="javascript:;" role="button" class="btn btn-block text-green nobg" data-role="add-model"><i class="fa fa-fw fa-plus"></i>添加材料证明</a>
			</div>
			<div class="box-footer text-center">
				<button type="submit" class="btn btn-success min-width-90px margin_r15" >发布</button>
