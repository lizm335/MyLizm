...
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">导入修改学籍信息</h3>
	</div>
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li class="process-step1 actived cur"><i></i>1.导入修改学籍信息表</li>
			<li class="process-step2"><i></i>2.导入创建修改学籍信息</li>
				...
				<div class="box-body process-cnt-box">
					<div class="media pad-t30 left10 margin_t10 margin_r15">
						...
						<div class="media-body">
							导入修改学籍信息前，建议先下载《修改学籍信息表》根据表设置好相关参数再导入。
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a href="javascript:void(0);" class="btn btn-primary btn-lg download_file" data-file="template">下载修改学籍信息表</a>
					</div>
						...
						<div class="table-row">
							<div class="table-cell-block vertical-mid">
								<div class="media pad-t10 left10 margin_r15">
									...
									<div class="media-body">
										请选择你要导入的《修改学籍信息表》，为保障导入修改能够顺利完成，导入前请确保表格模板正确，内容已按要求填写。
									</div>
								</div>
