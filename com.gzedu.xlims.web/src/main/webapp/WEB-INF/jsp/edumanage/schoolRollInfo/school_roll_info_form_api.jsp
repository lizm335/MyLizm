...
<body class="inner-page-body" style="padding-top: 0px;">
	<section class="content">
		...
		<div class="box no-border margin-bottom-none">
			<form id="inputForm" class="theform" role="form" action="${ctx }/api/roll/audit" method="post">
				<input type="hidden" name="action" value="${action}" />
				<input type="hidden" name="studentId" value="${item.studentId}" />
				<input type="hidden" name="auditOperatorRole" value="${auditOperatorRole}" />
				<input type="hidden" name="auditOperatorRealName" value="${auditOperatorRealName}" />
