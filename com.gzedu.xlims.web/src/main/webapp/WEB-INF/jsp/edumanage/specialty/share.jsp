					...
					<div class="table-block full-width full-height">
						<div class="table-cell-block vertical-mid">
							<table class="per-tbl" style="margin:0 auto;width:75%;">
								<tr>
									<th class="text-no-bold">共享专业：</th>
									<td>${entity.zymc}（${entity.zyh}）</td>
								</tr>
								<tr>
						...
						<div class="table-cell-block vertical-mid">
							<div class="center-block" style="width:70%;">
								...
								<div class="f16">
									<c:choose>
									<c:when test="${result}">
										恭喜你，${entity.gjtOrg.orgName}的《${entity.zymc}》共享成功
									</c:when>
									<c:otherwise>
										很遗憾，${entity.gjtOrg.orgName}的《${entity.zymc}》共享失败
									</c:otherwise>
									</c:choose>
								</div>
							</div>
