...
<div class="box no-border">
	...
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li class="process-step1 actived cur"><i></i>1.学员导入表</li>
			<li class="process-step2"><i></i>2.导入创建学员信息</li>
		...
		<div class="step-box">
				...
				<div class="box-body process-cnt-box">
					<div class="media pad-t30 left10 margin_t10 margin_r15">
						...
						<div class="media-body">
							为了方便你的工作，我们已经准备好了《学员导入表》的标准模板<br/>
							你可以点击下面的下载按钮，下载标准模板
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a href="javascript:void(0);" class="btn btn-primary btn-lg download_file" data-file="template">下载标准模板</a>
					</div>
			...
			<div class="step-item" style="display:none">
				<form id="uploadForm" name="uploadForm" action="importStuInfo" method="post" enctype="multipart/form-data">
								...
								<div class="pad-t30 col-xs-8 col-xs-offset-2">
									<div class="input-group input-group-md">
					                    ...
					                    <span class="input-group-btn">
					                    	...
					                    	<button class="btn btn-primary upload-btn" type="button">选择导入文件</button>
					                    </span>
                  					</div>
								</div>
							</div>
	...
	$(".import-sure-btn").click(function(event) {
		...
		$.ajax({
			...
			success: function(re){
				console.log(re);
				if("success" == re.msg ){
					$(".all_num").text("你本次共导入"+re.all_num+"条信息，导入结果如下:");
					$(".success_num").text("导入成功："+re.success_num+"条");
					$(".error_num").text("导入失败："+re.error_num +"条");
