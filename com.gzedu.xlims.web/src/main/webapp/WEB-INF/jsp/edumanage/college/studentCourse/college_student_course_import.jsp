...
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">批量导入学员选课</h3>
	</div>
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li class="process-step1 actived cur"><i></i>1.学员选课导入表</li>
			<li class="process-step2"><i></i>2.导入学员选课信息</li>
				...
				<div class="box-body process-cnt-box">
					<div class="media pad-t30 left10 margin_t10 margin_r15">
						...
						<div class="media-body">
							为了方便你的工作，我们已经准备好了《学员选课导入表》的标准模板<br/>
							你可以点击下面的下载按钮，下载标准模板
						</div>
					</div>
