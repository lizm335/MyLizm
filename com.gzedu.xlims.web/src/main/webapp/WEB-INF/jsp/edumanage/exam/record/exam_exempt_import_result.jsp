...
<div class="box no-border">
	...
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li data-role="step1" class="process-step1 actived"><i></i>1.下载模板</li>
			<li data-role="step2" class="process-step2 actived"><i></i>2.验证身份</li>
			<li data-role="step3" class="process-step2 actived"><i></i>3.导入数据</li>
			<li data-role="step4" class="process-step3 actived cur">4.导入结果反馈</li>
		</ol>
		<div class="step-box">
