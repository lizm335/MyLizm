...
<c:if test="${resultMap.TYPE eq 'RECORD' }">
	<form action="expExamRecord" id="expExamRecord" method="post" style="display: none;">
		<input type="hidden" name="XXZX_ID" value="${resultMap.XXZX_ID }">
		<input type="hidden" name="EXAM_STATE" value="${resultMap.EXAM_STATE }">
		<input type="hidden" name="XM" value="${resultMap.XM }">
		<input type="hidden" name="XH" value="${resultMap.XH }">
		<input type="hidden" name="EXAM_TYPE" value="${resultMap.EXAM_TYPE }">
		<input type="hidden" name="PYCC" value="${resultMap.PYCC }">
		<input type="hidden" name="SPECIALTY_ID" value="${resultMap.SPECIALTY_ID }">
		<input type="hidden" name="NJ" value="${resultMap.NJ }">
		<input type="hidden" name="YEARID" value="${resultMap.YEARID }">
		<input type="hidden" name="COURSE_ID" value="${resultMap.COURSE_ID }">
	</form>
</c:if>
<c:if test="${resultMap.TYPE eq 'REGISTER' }">
	<form action="expExamRegisterRecord" id="expExamRecord" method="post" style="display: none;">
		<input type="hidden" name="EXAM_STATE" value="${resultMap.EXAM_STATE }">
		<input type="hidden" name="EXAM_BATCH_CODE" value="${resultMap.EXAM_BATCH_CODE }">
		<input type="hidden" name="XM" value="${resultMap.XM }">
		<input type="hidden" name="XH" value="${resultMap.XH }">
		<input type="hidden" name="EXAM_TYPE" value="${resultMap.EXAM_TYPE }">
		<input type="hidden" name="PYCC" value="${resultMap.PYCC }">
...
<c:if test="${resultMap.TYPE eq 'EXPORTEXAMAPPOINTMENT' }">
	<form action="exportExamAppointment" id="expExamRecord" method="post" style="display: none;">
		<c:if test="${empty resultMap.EXAM_STATE }">
			<input type="hidden" name="EXAM_STATE" value="${resultMap.EXAM_STATE }">
		</c:if>
		<input type="hidden" name="EXAM_BATCH_CODE" value="${resultMap.EXAM_BATCH_CODE }">
		<input type="hidden" name="EXAM_PLAN_NAME" value="${resultMap.EXAM_PLAN_NAME }">
		<input type="hidden" name="XM" value="${resultMap.XM }">
		<input type="hidden" name="XH" value="${resultMap.XH }">
		<input type="hidden" name="EXAM_TYPE" value="${resultMap.EXAM_TYPE }">
		<input type="hidden" name="PYCC" value="${resultMap.PYCC }">
...
<c:if test="${resultMap.TYPE eq 'EXPORTEXAMDETAIL' }">
	<form action="exportExamDetail" id="expExamRecord" method="post" style="display: none;">
		<input type="hidden" name="EXAM_STATE" value="${resultMap.EXAM_STATE }">
		<input type="hidden" name="EXAM_BATCH_CODE" value="${resultMap.EXAM_BATCH_CODE }">
		<input type="hidden" name="XM" value="${resultMap.XM }">
		<input type="hidden" name="XH" value="${resultMap.XH }">
