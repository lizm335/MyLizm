...
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">统考/学位英语成绩登记</h3>
	</div>
									...
									<div class="alert custom-alert margin_b15">
							        	<div class="media no-padding">
							        		...
							        		<div class="media-body f12 media-middle text-left">
							        			导入前，请下载成绩导入模板，按照模板中的要求填写相关数据，确认无误后，请选择文件进行导入。
							        		</div>
							        	</div>
									</div>
									<p class="f16 margin_b15">
										<a href="downRecordResult?execleFileName=getRegisterTkXwImport">下载成绩导入模板 <i class="fa fa-fw fa-download"></i></a>
									</p>
									<form id="uploadForm" name="uploadForm" action="importRegisterTkXwRecord" method="post" enctype="multipart/form-data">
