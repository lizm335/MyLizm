	...
	<form id="listForm" class="form-horizontal">
		<div class="nav-tabs-custom no-margin">
			<ul class="nav nav-tabs nav-tabs-lg">
				<li><a href="#" data-toggle="tab" onclick="changType('1')">成绩查询</a></li>
				<shiro:hasPermission name="/exam/new/record/getExamRecordList$examRegister">
					<li class="active"><a href="#" data-toggle="tab" onclick="changType('2')">登记成绩</a></li>
				</shiro:hasPermission>
			</ul>
						...
						<div class="box-body">
							<div class="filter-tabs clearfix">
								...
								<div class="pull-right no-margin">
									...
									<shiro:hasPermission name="/exam/new/record/getExamRecordList$import">
										<a href="${ctx}/exam/new/record/getRegisterRecordImport" class="btn btn-default btn-sm margin_l10" data-role="register"><i class="fa fa-fw fa-sign-out"></i>登记成绩</a>
									</shiro:hasPermission>
									<shiro:hasPermission name="/exam/new/record/getExamRecordList$import">
										<a href="${ctx}/exam/new/record/getRegisterTkXwImport" class="btn btn-default btn-sm margin_l10" data-role="register"><i class="fa fa-fw fa-sign-out"></i>统考/学位英语登记成绩</a>
									</shiro:hasPermission>
								</div>
							</div>
								...
								<table class="table table-bordered table-striped vertical-mid text-center table-font">
						            ...
						            <tbody>
						            	...
						            	<tr>
						            		...
						            		<td>
						            			<c:choose>
						            				<c:when test="${not empty entity.EXAM_SCORE1}"><dic:getExamScore typeCode="EXAM_SCORE" code="${entity.EXAM_SCORE1 }" /></c:when>
						            				<c:otherwise>--</c:otherwise>
						            			</c:choose>
						            		</td>
						            		<td>
...
function getRecordCount(type, code) {
    $.ajax({
      type: "POST",
      dataType: "json",
      url: 'getRegisterCount?EXAM_STATE_TEMP='+code,
...
$('[data-role="export"]').click(function(event) {
    event.preventDefault();
    var data = $("#listForm").serialize()+"&TYPE=REGISTER";
    var self=this;
    $.mydialog({
        id:'export',
        width:600,
...
// 登记
$('[data-role="register"]').click(function(event) {
    event.preventDefault();
    var self=this;
    $.mydialog({
        id:'export',
