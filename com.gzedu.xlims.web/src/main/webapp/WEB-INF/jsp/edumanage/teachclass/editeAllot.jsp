            ...
            <div class="distribut-teacher table-block full-width no-margin">
                ...
                <div class="table-cell-block vertical-mid text-center">
                    <div class="form-group">
                        <button type="button" class="btn btn-primary" data-role="add"><span class="pad">添加&gt;</span></button>
                    </div>
                    <div class="form-group margin-bottom-none">
                        <button type="button" class="btn btn-danger" data-role="remove"><span class="pad">&lt;移除</span></button>
                    </div>
                </div>
                <div class="table-cell-block" style="width:40%;">
                    <div class="panel panel-default">
...
<script>
  ...
  //双击操作
    ...
    $('[data-role="sure"]').click(function(event) {
        ...
        $.post('${ctx}/edumanage/teachclass/allotHeadTeacherUpdate',{ids:'${ids}',employeeId:$liCollectors.find('input[name="employeeId"]').val()},function(data){
        	if(data.successful){
        		alert(data.message);
        		setTimeout(function(){
