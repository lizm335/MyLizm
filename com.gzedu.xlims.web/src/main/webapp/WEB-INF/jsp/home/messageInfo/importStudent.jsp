    ...
    <div class="pop-content">
        ...
        <div class="step-box">
                ...
                <div class="box-body process-cnt-box">
						<div class="media pad-t30 left10 margin_t10 margin_r15">
							...
							<div class="media-body">
								为了方便你的工作，我们已经准备好了《批量导入学员表》的标准模板<br> 你可以点击下面的下载按钮，下载标准模板。
							</div>
						</div>
						<div class="text-center pad-t30 margin_t10">
							<a href="${ctx }/excel/download?name=批量导入学员表.xls" target="_blank" class="btn btn-primary btn-lg"  style='width:220px;'>
	                                  下载标准模板
	                        </a>                            
                    </div>
            ...
            <div class="step-item" style="display:none">
                <form action="${ctx }/admin/messageInfo/saveImport?newMessageId=${newMessageId}" id="uploadForm" method="post" enctype="multipart/form-data">
			...
			<div class="step-item" style="display:none">
				...
				<div class="box-footer text-right process-btn-box">
					<button type="button" class="btn btn-default min-width-90px" data-role="close-pop">取消</button>
					<button type="button" class="btn btn-success min-width-90px margin_l15" data-role="btnOK">完成</button>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    $(function(){
        	...
        	$("#uploadForm").ajaxSubmit({
    			...
    			success: function(data) {
    				if (data.successful) {
    					...
    					$("#successFileName").attr("href", ctx+"/excelImport/downloadResult?path=message&name="+data.successFileName);
    					$("#failedFileName").attr("href", ctx+"/excelImport/downloadResult?path=message&name="+data.failedFileName);
        ...
        $("button[data-role='btnOK']").click(function(event) {
