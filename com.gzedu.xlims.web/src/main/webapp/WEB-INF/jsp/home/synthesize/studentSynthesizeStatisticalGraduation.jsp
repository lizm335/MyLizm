				...
				<div class="tab-pane active" id="tab_top_2">
					...
					<div class="box box-border margin-bottom-none">
						<ul class="nav nav-tabs nav-tabs-lg">
							...
							<li class="active"><a href="javascript:window.parent.loadPage('${ctx}/admin/home/studentSynthesizeStatisticalGraduation?${searchParams }');">毕业</a></li>
						...
						<div class="box-header with-border">
							<div class="filter-tabs clearfix">
								<ul class="list-unstyled">
									<li <c:if test="${empty param.STUDY_STATUS}">class="actived"</c:if> id="data_btn_all">全部(<span id="data_btn_all_num">3</span>)</li>
									<li <c:if test="${ param.STUDY_STATUS eq '0'}">class="actived"</c:if> id="data_btn_1">缴费正常(<span id="data_btn_1_num">1</span>)</li>
									<li <c:if test="${ param.STUDY_STATUS eq '1'}">class="actived"</c:if> id="data_btn_7">待缴费(<span id="data_btn_7_num">1</span>)</li>
									<li <c:if test="${ param.STUDY_STATUS eq '2'}">class="actived"</c:if> id="data_btn_7_3">异常，有欠费(<span id="data_btn_7_num">1</span>)</li>
								</ul>
								...
								<table class="table table-bordered table-striped vertical-mid text-center table-font">
						            ...
						            <tbody>
													<tr>
														...
														<td>
															<span class="text-green">已缴清</span>
														</td>
														<td>
													...
													<tr>
														...
														<td>
															<span class="text-orange">待缴费</span><br/>
														</td>
														<td>
															<a href="${ctx}/admin/home/studentSynthesizeStatistical/detail/${entity.STUDENT_ID}" class="operion-item" data-toggle="tooltip" title="查看详情"><i class="fa fa-fw fa-view-more"></i></a>
														</td>
													...
													<tr>
														...
														<td>
															<span class="text-orange">已欠费</span><br/>
															<span class="text-orange">（异常）</span>
														</td>
														<td>
															<a href="${ctx}/admin/home/studentSynthesizeStatistical/detail/${entity.STUDENT_ID}" class="operion-item" data-toggle="tooltip" title="查看详情"><i class="fa fa-fw fa-view-more"></i></a>
														</td>
