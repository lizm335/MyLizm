...
<html class="reset">
<head>
<title>管理系统 - 答疑服务-帮学员提问</title>
<%@ include file="/WEB-INF/jsp/common/jslibs.jsp"%>
</head>
<body>
	<form id="theform" action="${ctx}/lcmsubject/add" method="post">
...
.on('click', '[data-role="add-object"]', function(event) {
    ...
    $.mydialog({
        ...
        height:750,
        zIndex:11000,
        content: 'url:'+ctx+'/lcmsubject/findAnswerUser?studentId='+studentId
      });
})
//选择提问学员
.on('click', '[data-role="sel-stu"]', function(event) {
    $.mydialog({
        ...
        height:750,
        zIndex:11000,
        content: 'url:'+ctx+'/lcmsubject/findAskStudent'
      });
});
