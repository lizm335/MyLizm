		    	...
		    	<div class="box-body">
		    		<table class="table no-border">
		            	...
		            	<tr>
		            		...
		            		<td>
		            			<div class="position-relative">
		            				<textarea class="form-control" name="content1" placeholder="常见问题内容" datatype="*" nullmsg="请填写常见问题内容" errormsg="请填写常见问题内容" rows="5">
		                ...
		                <tr>
		                    ...
		                    <td>
		                        <div class="position-relative">
		                            <textarea class="form-control" name="content2" placeholder="回答" datatype="*" nullmsg="请填写回答内容" errormsg="请填写回答内容" rows="5">
