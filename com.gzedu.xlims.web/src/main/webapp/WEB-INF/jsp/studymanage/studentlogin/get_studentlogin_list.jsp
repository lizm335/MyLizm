		...
		<div class="nav-tabs-custom no-margin">
			<ul class="nav nav-tabs nav-tabs-lg">
				...
				<shiro:hasPermission name="/studymanage/getCourseLoginList$attendanceTab2">
					<li class="active"><a href="javascript:window.parent.loadPage('${ctx}/studymanage/getStudentLoginList');">学员考勤</a></li>
				</shiro:hasPermission>
			</ul>
						...
						<div class="box-header with-border">
							...
							<shiro:hasPermission name="/studymanage/getCourseLoginList$export">
								<div class="pull-right no-margin">
									<a href="${ctx}/studymanage/studentLoginListExport/${pageInfo.getTotalElements()}" class="btn btn-default btn-sm margin_l10" data-role="export"><i class="fa fa-fw fa-sign-out"></i> 导出学员考勤统计表</a>
								</div>
							</shiro:hasPermission>
							</div>
						</div>
											...
											<c:when test="${not empty pageInfo.content}">
												<c:forEach items="${pageInfo.content}" var="entity">
													<tr>
														...
														<td>
															<a href="${ctx}/studymanage/getStudentLoginDetail/${entity.STUDENT_ID}" class="operion-item" data-toggle="tooltip" title="查看详情"><i class="fa fa-fw fa-view-more"></i></a>
														</td>
													</tr>
												</c:forEach>
											</c:when>
...
function getRecordCount(type, code) {
    $.ajax({
        type: "POST",
        dataType: "json",
        url: 'getStudentLoginCount?STUDY_STATUS_TEMP='+code,
