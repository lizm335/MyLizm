	...
	<form id="listForm" class="form-horizontal">
		<div class="nav-tabs-custom no-margin">
			<ul class="nav nav-tabs nav-tabs-lg">
				<li class="active"><a href="javascript:window.parent.loadPage('${ctx}/studymanage/getScoreList');" >成绩查询</a></li>
				<shiro:lacksPermission name="/studymanage/getScoreList$schoolModel">
					<li><a href="javascript:window.parent.loadPage('${ctx}/studymanage/getCreditsList');" >学分查询</a></li>
					...
					<div class="box box-border margin-bottom-none">
						<div class="box-body">
							<div class="filter-tabs clearfix">
								...
								<shiro:hasPermission name="/studymanage/getScoreList$export">
									<div class="pull-right no-margin">
										<a href="${ctx}/studymanage/scoreListExport/${pageInfo.getTotalElements()}" class="btn btn-default btn-sm margin_l10" data-role="export"><i class="fa fa-fw fa-sign-out"></i> 导出学员成绩列表</a>
									</div>
								</shiro:hasPermission>
							</div>
...
function getRecordCount(type, code) {
    $.ajax({
      type: "POST",
      dataType: "json",
      url: 'getScoreListCount?EXAM_STATE_TEMP='+code,
      data: $('#listForm').serialize(),
      success: function (result) {
    	  $("#"+type).text(result.EXAM_STATE_COUNT);
      },
      error: function(data) {}
    });
}
