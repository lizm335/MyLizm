	...
	<div class="nav-tabs-custom no-margin">
		<ul class="nav nav-tabs nav-tabs-lg">
			<shiro:hasPermission name="/studymanage/getCourseStudyList$conditionTab1">
				<li class="active"><a href="javascript:window.parent.loadPage('${ctx}/studymanage/getCourseStudyList');" >课程学情</a></li>
			</shiro:hasPermission>
			...
			<div class="tab-pane active" id="tab_top_1">
				...
				<div class="box box-border margin-bottom-none">
					<div class="box-header with-border">
						<h3 class="box-title pad-t5">课程学情列表</h3>
							<div class="pull-right no-margin">
							<shiro:hasPermission name="/studymanage/getCourseStudyList$export">
								<a href="${ctx}/studymanage/courseActivityExport" class="btn btn-default btn-sm margin_l10" data-role="activity-export"><i class="fa fa-fw fa-sign-out"></i> 导出课程活动数据</a>
							</shiro:hasPermission>
							<shiro:hasPermission name="/studymanage/getCourseStudyList$exportCourseActivity">
								<a href="${ctx}/studymanage/courseStudyListExport/" class="btn btn-default btn-sm margin_l10" data-role="export"><i class="fa fa-fw fa-sign-out"></i> 导出课程学情统计表</a>
							</shiro:hasPermission>
							</div>
					</div>
					<div class="box-body">
									...
									<c:choose>
										<c:when test="${not empty pageInfo.content}">
											...
											<tr>
												...
												<td>
													<a href="${ctx}/studymanage/${entity.COURSE_ID}/${entity.GRADE_ID}/getCourseStudyDetails" class="operion-item" data-toggle="tooltip" title="查看详情"><i class="fa fa-fw fa-view-more"></i></a>
												</td>
											</tr>
											</c:forEach>
										</c:when>
...
<script type="text/javascript">
    ...
    $('[data-role="export"]').click(function(event) {
        ...
        $.mydialog({
            ...
            height:415,
            zIndex:11000,
            content: 'url:'+$(this).attr('href')+'${pageInfoTotalElements}'
        });
    });

    $('[data-role="activity-export"]').click(function(event) {
        event.preventDefault();
        var self=this;
        $.mydialog({
            id:'activity-export',
