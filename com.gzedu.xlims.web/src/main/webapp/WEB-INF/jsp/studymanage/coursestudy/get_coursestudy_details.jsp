                 ...
                 <div class="box-header with-border">
                    ...
                    <shiro:hasPermission name="/studymanage/getCourseStudyList$export">
                        <div class="pull-right no-margin">
                         <a href="${ctx}/studymanage/commonCourseConditionDetailExport/${pageInfo.getTotalElements()}" class="btn btn-default btn-sm margin_l10" data-role="export"><i class="fa fa-fw fa-sign-out"></i> 导出课程学情明细表</a>
                        </div>
                    </shiro:hasPermission>
                 </div>
                 <div class="box-body">
                         ...
                         <table class="table table-bordered table-striped vertical-mid text-center table-font">
                             ...
                             <c:forEach items="${pageInfo.content}" var="entity">
                                 <tr>
                                     ...
                                     <td>
                                         <c:choose>
                                             <c:when test="${not empty entity.SCHEDULE}">${entity.SCHEDULE }%</c:when>
                                             <c:otherwise>--</c:otherwise>
                                         </c:choose>
                                     </td>
                                     <td>
