        ...
        <div class="box-header with-border">
            <div class="filter-tabs clearfix pull-left no-margin">
                <ul class="list-unstyled">
                    ...
                    <li <c:if test="${param.MAIN_DEVICE eq 'APP'}">class="actived"</c:if> id="main_device_app">用APP学习人数(${APP_MAIN_DEVICE})</li>
                    <li <c:if test="${param.MAIN_DEVICE eq 'PC'}">class="actived"</c:if> id="main_device_pc">用PC学习人数(${PC_MAIN_DEVICE})</li>
                    <li <c:if test="${param.MAIN_DEVICE eq 'NO'}">class="actived"</c:if> id="main_device_no">从未学习人数(${NO_MAIN_DEVICE})</li>
                </ul>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped vertical-mid text-center table-font">
                    ...
                    <tr>
                        ...
                        <th style="width: 13%">报读信息</th>
                        <th style="width: 23%">开课信息</th>
                        <th>学习次数</th>
                        <th>学习时长<br>（小时）</th>
                        <th>主要应用终端</th>
                        <th>最近学习日期</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${item.LOGIN_COUNT ne 0}">
                                                ...
                                                <c:if test="${item.PC_ONLINE_PERCENT le item.APP_ONLINE_PERCENT}">APP<div class="gray9">（${item.APP_ONLINE_PERCENT}%）</div></c:if>
                                            </c:when>
                                    ...
                                    <td>
                                        <c:choose>
                                            ...
                                            <c:when test="${item.IS_ONLINE ne 'N' and item.IS_ONLINE ne 'N' and item.LOGIN_COUNT eq '0'}"><div class="gray9">离线<br>(从未学习)</div></c:when>
                                            <c:otherwise><div class="gray9">离线<br>(从未学习)</div></c:otherwise>
                                        </c:choose>
                                    </td>
...
<script type="text/javascript">
     ...
     * 切换app，pc选项卡的结果
     */
    $("#main_device_all,#main_device_app,#main_device_pc,#main_device_no").click(function () {
        var id = $(this).attr("id");
        switch (id){
