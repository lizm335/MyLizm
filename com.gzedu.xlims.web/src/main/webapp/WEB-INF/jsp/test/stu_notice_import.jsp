...
<title>导入修改学籍信息</title>
<%@ include file="/WEB-INF/jsp/common/jslibs.jsp"%>
</head>
<body>
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">导入学员信息</h3>
	</div>
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li class="process-step1 actived cur"><i></i>1.下载学员信息模板</li>
			<li class="process-step2"><i></i>2.导入学员信息</li>
		...
		<div class="step-box">
				...
				<div class="box-body process-cnt-box">
					<div class="media pad-t30 left10 margin_t10 margin_r15">
						...
						<div class="media-body">
							导入学员信息前，建议先下载《学员信息模板》根据表设置好相关参数再导入。
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a href="javascript:void(0);" class="btn btn-primary btn-lg download_file" data-file="template">下载学员信息模板</a>
					</div>
			...
			<div class="step-item" style="display:none">
				<form id="uploadForm" name="uploadForm" action="importStuInfo.html" method="post" enctype="multipart/form-data">
						...
						<div class="table-row">
							<div class="table-cell-block vertical-mid">
								<div class="media pad-t10 left10 margin_r15">
									...
									<div class="media-body">
										请选择你要导入的《学员信息》，为保障导入修改能够顺利完成，导入前请确保表格模板正确，内容已按要求填写。
									</div>
								</div>
							...
							<div class="table-cell-block vertical-mid">
								<div class="exception" style="width:305px;margin:0 auto;">
									...
									<p class="margin_b20">
										...
										<button class="btn btn-default btn-sm left10 download_file success_file">下载入学通知书</button>
									</p>
									<p class="">
...
$(function(){
	...
	$(".download_file").click(function(event) {
		window.location.href="download.html?file="+$(this).attr("data-file");
	});
