...
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">图片压缩</h3>
	</div>
	<div class="pop-content">
		<ol class="list-unstyled clearfix process-list">
			<li class="process-step1 actived cur"><i></i>1.说明</li>
			<li class="process-step2"><i></i>2.图片压缩</li>
			<li class="process-step3">3.压缩结果</li>
		</ol>
		...
		<div class="step-box">
			...
			<div class="step-item" style="display:none">
				<form id="uploadForm" name="uploadForm" action="importZipImage.html" method="post" enctype="multipart/form-data">
							...
							<div class="table-cell-block vertical-mid">
								<div class="exception" style="width:305px;margin:0 auto;">
									...
									<p class="margin_b20">
										...
										<button class="btn btn-default btn-sm left10 download_file success_file">下载压缩的图片</button>
									</p>
									<p class="">
	...
	$(".import-sure-btn").click(function(event) {
		...
		$.ajax({
			...
			success: function(re){
				console.log(re);
				if("success" == re.msg ){
					$(".all_num").text("本次共压缩了"+re.all_num+"个记录，结果如下:");
