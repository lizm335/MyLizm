		...
		<div class="box-body pad20">
			...
			<%-- 	<c:if test="${queryStudyYear<1 }">
				...
				<li>
					...
					<span>请为院校添加班主任</span>
					<a class="agency-link" href="${ctx }/edumanage/teachEmployee/list.html?action=headTeacher"><small>进入处理</small></a>
				</li>
				</c:if>
				...
				<li>
					...
					<a class="agency-link" href="${ctx }/edumanage/teachEmployee/list.html?action=coachTeacher"><small>进入处理</small></a>
				</li>
				</c:if>
				...
				<li>
					...
					<a class="agency-link" href="${ctx }/edumanage/teachEmployee/list.html?action=supervisorTeacher"><small>进入处理</small></a>
				</li>
				</c:if>
<%-- 				<c:if test="${queryStudyYearRenWu<1 }">
				...
				<li>
					<small class="label pull-left bg-red">教务班级</small>
					<span>请为教务班级分配班主任！</span>
