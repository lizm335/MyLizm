				...
				<div class="box-body process-cnt-box">
					<div class="media left10 pad-t15 margin_r15">
						...
						<div class="media-body">
							...
							《毕业论文记录明细表》，你可以点击下面的下载按钮，下载标准模板。
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a class="btn btn-primary btn-lg" style='width:220px;' href="${ctx}/thesisApply/export?search_EQ_status=8">下载标准模板</a>
					</div>
					...
					<div class="table-block full-width" style="height:100%;">
						<div class="table-row">
							<div class="table-cell-block vertical-mid text-center">
								...
								请选择你要导入的《确认收到定稿名单》，并选择需要导入到的论文计划
								</p>
								<form id="uploadForm" action="${ctx}/thesisApply/importConfirmExpress" enctype="multipart/form-data" method="post">
    	...
    	$("#uploadForm").ajaxSubmit({
			...
			success: function(data) {
				if (data.successful) {
					...
					$("#successFileName").attr("href", ctx+"/excelImport/downloadResult?path=thesisApply&name="+data.successFileName);
					$("#failedFileName").attr("href", ctx+"/excelImport/downloadResult?path=thesisApply&name="+data.failedFileName);
