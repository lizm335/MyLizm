...
<div class="box no-border">
	<div class="box-header with-border">
		<h3 class="box-title">批量导入答辩安排</h3>
	</div>
				...
				<div class="box-body process-cnt-box">
					<div class="media left10 pad-t15 margin_r15">
						...
						<div class="media-body">
							为了方便你的工作，我们已经准备好了《答辩安排导入表》的标准模板<br>
							你可以点击下面的下载按钮，下载标准模板。
						</div>
					</div>
					<div class="text-center pad-t30 margin_t10">
						<a class="btn btn-primary btn-lg" style='width:220px;' href="${ctx}/excel/download?name=答辩安排导入表.xls">下载标准模板</a>
					</div>
					...
					<div class="table-block full-width" style="height:100%;">
						<div class="table-row">
							<div class="table-cell-block vertical-mid text-center">
								...
								请选择你要导入的《答辩安排导入表》，并选择需要导入到的论文计划
								</p>
								<form id="uploadForm" action="${ctx}/thesisDefencePlan/import" enctype="multipart/form-data" method="post">
