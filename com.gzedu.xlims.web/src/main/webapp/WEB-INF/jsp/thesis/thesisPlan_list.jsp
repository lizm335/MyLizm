	      ...
	      <div class="row pad-t15">
	        <div class="col-sm-4 col-xs-6">
	          <div class="form-group">
	            ...
	            <div class="col-sm-9">
	              <input type="text" class="form-control" name="search_LIKE_thesisPlanCode" value="${param.search_LIKE_thesisPlanCode}" placeholder="计划编号">
	            </div>
	          </div>
	        </div>
	        <div class="col-sm-4 col-xs-6">
	          <div class="form-group">
	            ...
	            <div class="col-sm-9">
	              <input type="text" class="form-control" name="search_LIKE_thesisPlanName" value="${param.search_LIKE_thesisPlanName}" placeholder="计划名称">
	            </div>
	          </div>
	        </div>
		...
		<div class="box-header with-border">
		  ...
		  <div class="pull-right no-margin">
		  	<c:if test="${isBtnCreate }">
		    	<a href="create" class="btn btn-default btn-sm"><i class="fa fa-fw fa-plus"></i> 新增毕业论文计划</a>
		    </c:if>
		  </div>
		</div>
		<div class="box-body">
		            		...
		            		<c:when test="${not empty pageInfo.content}">
								<c:forEach items="${pageInfo.content}" var="entity">
									<c:if test="${not empty entity}">
						            	<tr>
						            		<td rowspan="7">${entity.thesisPlanCode}</td>
						            		<td rowspan="7">
						            			${entity.thesisPlanName}
						            		</td>
						            		<td rowspan="7">
						            		...
						            		<td rowspan="7">
						            			<c:if test="${canApproval && entity.status == 1}">
						            				<a href="view/${entity.thesisPlanId}?isApproval=true" class="operion-item" data-toggle="tooltip" title="审核"><i class="fa fa-shxxjl"></i></a>
						            			</c:if>
						            			<c:if test="${entity.status2 != 3 && isBtnUpdate}">
						            				<a href="update/${entity.thesisPlanId}" class="operion-item" data-toggle="tooltip" title="编辑"><i class="fa fa-edit"></i></a>
						            			</c:if>
						            			<c:if test="${isBtnView}">
						            				<a href="view/${entity.thesisPlanId}" class="operion-item" data-toggle="tooltip" title="查看明细"><i class="fa fa-view-more"></i></a>
						            			</c:if>
						            			<c:if test="${entity.status == 2 && isBtnDelete}">
						            				<a href="javascript:void(0);" class="operion-item operion-del del-one" val="${entity.thesisPlanId}" data-toggle="tooltip" title="删除"><i class="fa fa-trash-o text-red"></i></a>
						            			</c:if>
						            		</td>
						            	</tr>
						            	<tr>
