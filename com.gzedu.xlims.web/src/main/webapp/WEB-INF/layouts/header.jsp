								...
								<ul class="menu-temp hide">
									...
									<li class="treeview">
									  ...
									  <ul class="treeview-menu">
										<li><a href="${ctx}/admin/model/list"><i class="fa fa-circle-o"></i>系统菜单</a></li>
									  </ul>
									</li>
								</ul>
							</li>
							 <c:forEach items="${modelInfoList}" var="model">
						      	<li data-id="2"> 
									${model.modelName }
									<ul class="menu-temp hide">
										...
										<li class="treeview">
											  ...
											  <ul class="treeview-menu">
											  	<c:forEach items="${child.childModelList}" var="child2">
													<li><a href="p1-1.html"><i class="fa fa-circle-o"></i>${child.modelName}</a></li>
												</c:forEach>
											  </ul>
										</li>
									 </c:forEach>
				  ...
				  <li class="dropdown tasks-menu">
					...
					<li class="dropdown user user-menu"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"> <img
							...
							class="user-image" alt="User Image"> <span class="hidden-xs"> boss </span>
					</a>
						<ul class="dropdown-menu">
							<!-- User image -->
