...
import com.gzedu.xlims.constants.ShiroCacheManager;
...
public class SimpleWebSessionManager extends DefaultWebSessionManager implements WebSessionManager {
	...
	private String keyPrefix = "SHIRO-ACTIVESESSIONCACHE";
	...
	public void validateSessions() {
		...
		List<String> list = gjtUserAccountDao.findSeesionId(type);
		for (String id : list) {
			try {
