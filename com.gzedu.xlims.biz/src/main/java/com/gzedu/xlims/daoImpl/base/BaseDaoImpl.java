 ...
 */
package com.gzedu.xlims.daoImpl.base;
...
public class BaseDaoImpl {
	 ...
	 * @return
	 */
	public <T> Page<T> findByPageHql(StringBuilder queryHql, Map<String, Object> params, PageRequest pageRequest,
			Class<T> resultClass) {
	 ...
	 * @return
	 */
	public <T> List<T> findAllByHql(StringBuilder queryHql, Map<String, Object> params, Sort sort,
			Class<T> resultClass) {
		if (sort != null) {
			queryHql.append(" ORDER BY ");
	 ...
	 * @return
	 */
	public <T> Page<T> findByPageSql(StringBuilder querySql, Map<String, Object> params, PageRequest pageRequest,
			Class<T> resultClass) {
	 ...
	 * @return
	 */
	public <T> List<T> findAllBySql(StringBuilder querySql, Map<String, Object> params, Sort sort,
			Class<T> resultClass) {
		if (sort != null) {
			querySql.append(" ORDER BY ");
			for (Iterator<Sort.Order> iter = sort.iterator(); iter.hasNext();) {
