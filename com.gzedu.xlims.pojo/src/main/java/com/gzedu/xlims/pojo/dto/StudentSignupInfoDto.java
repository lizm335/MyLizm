...
public class StudentSignupInfoDto {
	...
	private String gradeSpecialtyId; // 产品ID
	...
	private String xxzxCode; // 学习中心编码
	...
	private Integer flowAuditOperatorRole; // 审核记录最新审核人角色 1-学员 2-班主任 3-招生办
											// 4-学籍科主任
	...
	private String eesync; // 同步EE，默认为N Y-已同步 N-未同步
	...
	public void setXxzxCode(String xxzxCode) {
		this.xxzxCode = xxzxCode;
	}
