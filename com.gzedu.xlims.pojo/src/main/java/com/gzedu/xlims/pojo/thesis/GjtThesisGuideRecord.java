...
/**
 * The persistent class for the GJT_THESIS_GUIDE_RECORD database table.
 * 
 */
@Entity
@Table(name="GJT_THESIS_GUIDE_RECORD")
@NamedQuery(name="GjtThesisGuideRecord.findAll", query="SELECT g FROM GjtThesisGuideRecord g")
public class GjtThesisGuideRecord implements Serializable {
