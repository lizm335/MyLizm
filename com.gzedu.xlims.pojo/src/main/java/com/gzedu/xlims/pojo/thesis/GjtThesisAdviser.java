...
/**
 * The persistent class for the GJT_THESIS_ADVISER database table.
 * 
 */
@Entity
@Table(name="GJT_THESIS_ADVISER")
@NamedQuery(name="GjtThesisAdviser.findAll", query="SELECT g FROM GjtThesisAdviser g")
public class GjtThesisAdviser implements Serializable {
	...
	private GjtThesisArrange gjtThesisArrange;
	...
	public GjtThesisArrange getGjtThesisArrange() {
		return this.gjtThesisArrange;
	}

	public void setGjtThesisArrange(GjtThesisArrange gjtThesisArrange) {
		this.gjtThesisArrange = gjtThesisArrange;
	}
	...
	public String toString() {
		return "GjtThesisAdviser [adviserId=" + adviserId + ", adviserNum=" + adviserNum + ", adviserType="
