...
public class GjtSpecialtyPlan implements Serializable {
	...
	private int courseCategory = 0;// 课程属性,0必修，1选修，2补修
	...
	private String examPaperNum;// 试卷号
	...
	private List<GjtTextbook> gjtTextbookList;
	...
	private List<GjtTextbookPlanOwnership> gjtTextbookPlanOwnershipList;
	...
	public List<GjtTextbookPlanOwnership> getGjtTextbookPlanOwnershipList() {
		return gjtTextbookPlanOwnershipList;
	}

	public void setGjtTextbookPlanOwnershipList(List<GjtTextbookPlanOwnership> gjtTextbookPlanOwnershipList) {
