...
public class GjtSetOrgCopyright implements Serializable {
	...
	private String schoolModel;// 0非院校，1院校模式，2院校模式阉割版没有考试
	...
	@Column(name = "QCODE_PIC") // 下载个人中心的APP二维码地址
	private String qcodePic;

	@Transient
	private String xxCode; // 参考OrgUtil的code

	public GjtSetOrgCopyright(String xx_id, int platfromType) {
