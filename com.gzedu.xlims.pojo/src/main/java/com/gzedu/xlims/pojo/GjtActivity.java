...
public class GjtActivity implements Serializable {
	...
	@Transient
	private long colWaitActivityNum;// 待审核人数

	// @Transient
	// private int isEnter; // 学生是否参加，数据库不存在0否1是
	//
	// @Transient
	// private BigDecimal studentAuditStatus; // 学生是否参加审核通过，数据库不存在
