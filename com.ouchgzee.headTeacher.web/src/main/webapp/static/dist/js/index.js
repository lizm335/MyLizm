...
$(".operion-more-menu > ul > li").each(function(i,ele){
	...
	$(".first-level-menu").append([
		'<li data-id="'+$that.attr("data-id")+'" data-url="'+$that.find('.menu-temp a:first').attr('href')+'"'+(i==0?' class="cur"':'')+'>',
...
/**侧边菜单**/
$(document).on("click",".sidebar-menu a,a[data-page-role='single-page']",function(event){
