...
+function ($) {
	...
	Confirmation.DEFAULTS = $.extend({}, $.fn.popover.Constructor.DEFAULTS, {
		...
		btnGroupClass	: 'text-right',
		href 			: '#',
		target 			: '_self',
		singleton 		: true,
		popout 			: true,
		popContentWidth	: false,
	...
	Confirmation.prototype.setContent = function () {
		...
		if(this.getHref()!="#"){
			...
			.attr('target', this.getTarget()).off('click');
		}
		...
		$tip.find('.popover-txt')[this.options.html ? 'html' : 'text'](this.getContent());
		
		if(this.options.popContentWidth){
			$tip.width(this.options.popContentWidth);
		}
		
		$tip.find('.popover-btn-box').addClass(this.getBtnGroupClass());
	...
	Confirmation.prototype.getBtnGroupClass = function () {
		var $e = this.$element;
		var o  = this.options;

		return $e.attr('data-btnGroupClass') || o.btnGroupClass;
	}
