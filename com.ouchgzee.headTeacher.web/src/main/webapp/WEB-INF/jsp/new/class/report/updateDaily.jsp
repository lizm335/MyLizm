...
<section class="content">
  ...
  <div class="box margin-bottom-none">
    <div class="box-body pad20">
      <form id="theform" role="form" action="${ctx }/home/class/report/doUpdateReport/${info.id}" method="post">
          ...
          <div class="table-block full-width position-relative add-remind-tbl">
            <div class="table-row">
              ...
              <div class="table-cell-block position-relative">
             	 <input type="hidden" id="updateDt" name="updateDt" value=""/>
            ...
            <div class="table-row">
              ...
              <div class="table-cell-block position-relative">
                <textarea name="summary" class="form-control" rows="5" placeholder="提示性文字，如今天主要完成了哪些工作任务，遇到什么问题，如何解决之类的。"  datatype="*" nullmsg="请填写本日总结！" errormsg="请填写本日总结！">${info.summary}</textarea>
