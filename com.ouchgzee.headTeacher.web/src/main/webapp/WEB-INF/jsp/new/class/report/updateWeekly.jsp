...
<section class="content">
  <div class="box margin-bottom-none">
    <div class="box-body pad20">
      <form id="theform" action="${ctx }/home/class/report/doUpdateReportWeekly/${info.id}" method="post">
        <div class="slim-Scroll">
          <div class="table-block full-width position-relative add-remind-tbl">
            <div class="table-row">
              ...
              <input type="hidden" name="updatedDt" id="updatedDt" value=""/>
              <input type="hidden" name="beginTime" id="beginTime" value="${info.beginTime}"/>
              <input type="hidden" name="endTime" id="endTime" value="${info.endTime}"/>
            ...
            <div class="table-row">
              ...
              <div class="table-cell-block position-relative">
                <textarea name="summary" class="form-control" rows="5" placeholder="提示性文字，如本周主要完成了哪些工作任务，遇到什么问题，如何解决之类的。"  datatype="*" nullmsg="请填写本周总结！" errormsg="请填写本周总结！">${info.summary}</textarea>
            ...
            <div class="table-row">
              ...
              <div class="table-cell-block position-relative">
                <textarea name="nextplan" class="form-control" rows="5" placeholder="提示性文字，如对下周需要完成的工作任务制定具体计划。"  datatype="*" nullmsg="请填写下周计划！" errormsg="请填写下周计划！">${info.nextplan}</textarea>
                <div class="tooltip top" role="tooltip">
                  <div class="tooltip-arrow"></div>
                  <div class="tooltip-inner"></div>
                </div>
            ...
            <div class="table-row">
              ...
              <div class="table-cell-block position-relative">
                <button type="button" class="btn btn-success min-width-90px  btn-sure-edit">修改</button>
