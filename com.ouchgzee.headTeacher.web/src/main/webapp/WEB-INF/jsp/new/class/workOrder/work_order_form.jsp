...
<%@ include file="/WEB-INF/jsp/new/common/footerjslibs.jsp"%>
	...
	$('[data-role="add-person-btn"]').on('click', function(event) {
		...
		$.mydialog({
		  ...
		  content: 'url:${ctx}/home/class/workOrder/findRole?type=1'
		});
	});
	...
	$('[data-role="add-cc-btn"]').on('click', function(event) {
		...
		$.mydialog({
		  ...
		  content: 'url:${ctx}/home/class/workOrder/findRole?type=2'
		});
	});
		/*失败状态
		$.resultDialog(
				...
				setTimeout(function(){
					$.closeDialog(postIngIframe);
						if(data.successful==true){
							window.location.href='${ctx}/home/class/workOrder/putList';
						}
				},2000); 
	      }
	    });
