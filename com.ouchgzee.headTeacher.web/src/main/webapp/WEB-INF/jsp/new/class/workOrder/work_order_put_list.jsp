									...
									<div class="row pad-t15">
										<div class="col-sm-4 col-xs-6">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="search_LIKE_title" value="${param.search_LIKE_title}"> <input type="hidden"
														class="form-control" name="search_EQ_isState" value="${param.search_EQ_isState}">
												</div>
											</div>
										</div>
										<div class="col-sm-4 col-xs-6">
												...
												<c:when test="${not empty pageInfo.content}">
													<c:forEach items="${pageInfo.content}" var="info">
														<tr>
															...
															<td>
																<shiro:hasPermission name="/home/class/workOrder/list$update">
																...
																<shiro:hasPermission name="/home/class/workOrder/list$colseWorkOrder"> 
																	<c:if test="${info.isState eq '1' }"> 
															 	...
															 	<shiro:hasPermission name="/home/class/workOrder/list$delete"> 
