...
<section class="content">
	...
	<div class="nav-tabs-custom reset-nav-tabs-custom" id="notice-tabs" style="margin-bottom: 0px;">
		<div class="pull-right margin_r10 margin_t10">
			<a href="${ctx}/home/class/remind/create" role="button" class="btn btn-default btn-add"><i class="fa fa-fw fa-plus"></i> 新增提醒</a>
		</div>
		<ul class="nav nav-tabs nav-tabs-lg">
			<li><a href="${ctx}/home/class/remind/eeList">EE提醒</a></li>
			<li class="active"><a href="${ctx}/home/class/remind/smsList" data-toggle="tab">手机短信</a></li>
		</ul>
										...
										<li class="news-item">
											<div class="media">
												<div class="media-body">
													<p class="news-tit">
														<a href="view/${info.messageId}?source=2">
																${info.infoContent}
														</a>
													</p>
	...
	$('body').confirmation({
		...
		onConfirm:function(event,element){
			if(objId != null) {
				...
				$.post("resend",{id:id, isSendSMS:'1'},function(data){
					if(data.successful){
						showSueccess(data);
