package com.ouchgzee.headTeacher.web.common.vo;
...
public class LcmsMutualSubjectVO {
	...
	private String isComm;// 是否常见问题 Y是，N不是
	private String isState;// 是否已解答N未解答，Y解答
	...
	private String singUrl; // html5Url
	...
	public LcmsMutualSubjectVO(LcmsMutualSubject item, Map<String, String> pyccMap, GjtStudentInfo studentInfo) {
		...
		if (studentInfo != null) {
			...
			this.specialtyName = studentInfo.getGjtSpecialty().getZymc();
			// this.url =
			// SimulationUtils.studentSimulation(gjtStudentInfo.getStudentId(),
			// gjtStudentInfo.getXh(),requestUrl);
		}
