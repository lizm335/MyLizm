...
public class InitDicListener implements ServletContextListener{
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        BzrDictionaryService dictionaryService = appContext.getBean(BzrDictionaryService.class);
        // 加载数据字典
        List<BzrTblSysData> dataList = dictionaryService.queryBy(Collections.EMPTY_MAP, new Sort(new Sort.Order("typeCode"), new Sort.Order("ordNo")));
        ...
        System.out.println("初始化完成success");
    }
