...
import com.ouchgzee.headTeacher.pojo.status.EnumDictionaryType;
import com.ouchgzee.headTeacher.pojo.status.EnumStatus;


@Deprecated public class BzrSysDictionary implements Identifiable{
