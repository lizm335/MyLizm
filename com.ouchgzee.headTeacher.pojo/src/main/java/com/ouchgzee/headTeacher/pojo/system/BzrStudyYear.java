 ...
 */
package com.ouchgzee.headTeacher.pojo.system;
 ...
 *
 */
@Deprecated public class BzrStudyYear {
	...
	public static void main(String[] args) {
		Date startDate = BzrStudyYear.getStartDate(22);
		Date endDate = BzrStudyYear.getEndDate(22);
		System.out.println(DateUtils.getTimeYMD(startDate));
		System.out.println(DateUtils.getTimeYMD(endDate));

		// 所有学期
		int[] codes = BzrStudyYear.getCodes(new Date());
