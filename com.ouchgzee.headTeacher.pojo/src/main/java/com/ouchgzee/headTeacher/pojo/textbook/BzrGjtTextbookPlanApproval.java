...
/**
 * The persistent class for the GJT_TEXTBOOK_PLAN_APPROVAL database table.
 * 
 */
@Entity
@Table(name = "GJT_TEXTBOOK_PLAN_APPROVAL")
// @NamedQuery(name = "GjtTextbookPlanApproval.findAll", query = "SELECT g FROM GjtTextbookPlanApproval g")
@Deprecated public class BzrGjtTextbookPlanApproval implements Serializable {
	...
	public BzrGjtTextbookPlanApproval() {
	}
	...
	public String toString() {
		return "GjtTextbookPlanApproval [approvalId=" + approvalId + ", createdBy=" + createdBy + ", createdDt="
				+ createdDt + ", deletedBy=" + deletedBy + ", deletedDt=" + deletedDt + ", description=" + description
				+ ", isDeleted=" + isDeleted + ", operaRole=" + operaRole + ", operaType=" + operaType + "]";
	}
