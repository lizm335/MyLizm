...
@Deprecated public class BzrGjtSignup implements Serializable {
	...
	@OneToOne(fetch = FetchType.LAZY, optional = false, cascade = { CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REFRESH })
	...
	private BzrGjtEnrollBatch gjtEnrollBatch;

	@OneToMany(cascade = { CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REFRESH })
	@JoinColumn(name="SIGNUP_ID")
	private List<BzrGjtSignupData> gjtSignupDataList;
	...
	@Column(name = "SIGNUP_SPECIALTY_ID")
	...
	/**
	 * @return the gjtEnrollBatch
	 */
	public BzrGjtEnrollBatch getGjtEnrollBatch() {
		return gjtEnrollBatch;
	}

	/**
	 * @param gjtEnrollBatch
	 *            the gjtEnrollBatch to set
	 */
	public void setGjtEnrollBatch(BzrGjtEnrollBatch gjtEnrollBatch) {
		this.gjtEnrollBatch = gjtEnrollBatch;
	}

	public List<BzrGjtSignupData> getGjtSignupDataList() {
		return gjtSignupDataList;
	}

	public void setGjtSignupDataList(List<BzrGjtSignupData> gjtSignupDataList) {
		this.gjtSignupDataList = gjtSignupDataList;
	}
