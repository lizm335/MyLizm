...
@Controller
@RequestMapping("/sso")
public class SSOCustomerService2LoginController extends BaseController {

	private static final Log log = LogFactory.getLog(SSOCustomerService2LoginController.class);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/signonToStuInfo2")
	public ModelAndView signonToStuInfo(String sign, HttpServletRequest request, HttpServletResponse response,
		...
		// 校验token
		if (!MoorApiUtil.checkTokenLegal(MoorApiUtil.Account.ACCOUNT02, qtoken, qtokenId)) {
